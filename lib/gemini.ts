...
const LLM_API_BASE = 'https://generativelanguage.googleapis.com/v1beta/openai/v1';
...
const RESPONSE_FORMAT = LLM_API_BASE.includes('generativelanguage.googleapis.com')
...
async function callGemini(prompt: string, apiKey: string, maxRetries = 2): Promise<string> {
